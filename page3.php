...
<form method="post" name="form1" action="success.php" >
	<?php
echo "<font size='3'><b>1.".$text9."</b></font><br><br>";
?>

<input type="radio"name="op5" required>a) int _a3;<br>
<input type="radio"name="op5">b) int a_3;<br>
<input type="radio"name="op5">c) int 3_a;<br>
<input type="radio"name="op5">d) int _3a<br><br>
<?php
echo "<font size='3'><b>2.".$text10."</b></font><br><br>";
?>
<input type="radio" name="op6" required>a) Compiler and linker implementations<br>
<input type="radio" name="op6" >b) Assemblers and loaders implementations<br>
<input type="radio" name="op6" >c) C language<br>
<input type="radio" name="op6" >d) None of the mentioned<br><br>
<?php
echo "<font size='3'><b>3.".$text11."</b></font><br><br>";
?>
<input type="radio" name="op7" required>a) 31<br>
<input type="radio" name="op7">b) 63<br>
<input type="radio" name="op7">c) 12<br>
<input type="radio" name="op7">d) 14<br><br>
<?php
echo "<font size='3'><b>4.".$text12."</b></font><br><br>";
?>
